...
def menu(
    ...
    if role == "admin":
        kb = [
            ...
            [
                InlineKeyboardButton(
                    text=f"{e['admin_tickets']} Заявки IT", callback_data=f"{nonce}:admin_tickets"
                )
            ],
            [
                InlineKeyboardButton(
                    text=f"{e['admin_media']} Медиацентр", callback_data=f"{nonce}:admin_media"
                )
            ],
        ]
        return InlineKeyboardMarkup(inline_keyboard=kb)
    ...
    if role == "parent":
        kb = [
            [
                InlineKeyboardButton(
                    text=f"{e['par_tasks']} Задания ребёнка", callback_data=f"{nonce}:par_tasks"
                )
            ],
            [
                InlineKeyboardButton(
                    text=f"{e['par_cert']} Заказать справку", callback_data=f"{nonce}:par_cert"
                )
            ],
        ]
        return InlineKeyboardMarkup(inline_keyboard=kb)
    ...
    if role == "student":
        kb = [
            [
                InlineKeyboardButton(
                    text=f"{e['stu_tasks']} Задания", callback_data=f"{nonce}:stu_tasks"
                )
            ],
            [
                InlineKeyboardButton(
