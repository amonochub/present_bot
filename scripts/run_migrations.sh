...
echo "🔄 Запуск инициализации и миграций базы данных..."

# Сначала проверяем и инициализируем БД SQL-скриптами
if [ -f "/app/scripts/init_db.sh" ]; then
    echo "🗄️ Запуск инициализации БД..."
...
echo "⚠️  Демо-данные временно отключены для быстрого запуска"
